                          ...
                          <div class="table-responsive-sm">
                            <table class="table table-sm table-striped table-bordered table-hover dataTables-example" >
                              ...
                              <tbody>
                                <?php 
                                $no = 1;
                                $data = sqlsrv_query($koneksi,"SELECT * FROM tmastercustomer ORDER BY kode_master ASC");
                        ...
                        <div class="table-responsive-sm">
                          <table class="table table-sm table-striped table-bordered table-hover dataTables-example" >
                            ...
                            <tbody>
                              <?php 
                              $no = 1;
                              $data = sqlsrv_query($koneksi,"SELECT b.Kode,a.Customer,b.Nama,b.Kota FROM tmastercustomer a INNER JOIN tcustomer b ON a.kode_master=b.Kode_master ORDER BY b.Kode ASC ");
                              while($d = sqlsrv_fetch_array($data)){
                                ?>
                                <tr>
                                 <td width="5"><?php echo $no++; ?></td>
