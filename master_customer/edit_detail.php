							...
							<div class="tab-content">
									...
									<div class="panel-body">
										...
										<div class="ibox-content">
											<div class="form-group row"><label class="col-sm-1 col-form-label">kode Master <font color="red">*</font></label>
												<div class="col-sm-11"><select class="form-control m-b form-control-sm selectpicker" name="kodemaster" data-live-search="true" >
                                                    ...
                                                    while ($kelas = sqlsrv_fetch_array($query)) {
                                                        ...
                                                        echo "<option $select value=".$kelas['kode_master'].">".$kelas['kode_master']."</option>";
                                                     }
                                                      ?>
												</select>
											</div>
								...
								<div class="form-group row"><label class="col-sm-1 col-form-label">Kode Pos<font color="red">*</font></label>
										...
										<div class="form-group row"><label class="col-sm-1 col-form-label">Status<font color="red">*</font></label>
											<div class="col-sm-2"><input maxlength="2" type="text" class="form-control form-control-sm" name="status" value="<?php echo $data['Status'];?>">
											</div>
										</div>
										<div class="form-group row"><label class="col-sm-1 col-form-label">Hapus<font color="red">*</font></label>
											<div class="col-sm-2"><input maxlength="50" type="text" class="form-control form-control-sm" name="hapus" value="<?php echo $data['Hapus'];?>">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-1 col-form-label">Non Aktif</label>
											<div class="col-sm-5">
												<input type="text" class="form-control form-control-sm" name="nonaktif" value="<?php echo $data['NonAktif'];?>"> 
											</div>
											<label class="col-sm-1 col-form-label">Non Aktif Jual</label>
											<div class="col-sm-5">
												<input type="text" class="form-control form-control-sm" name="nonaktifjual" value="<?php echo $data['NonAktifJual'];?>"> 
											</div>
										</div>
									</div>
								</div>
